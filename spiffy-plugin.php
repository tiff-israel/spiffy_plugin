...
//Page Slug Body Class
// http://www.peterrknight.com/short-body-classes-for-page-templates-wordpress/
function spiffy_page_template_body_classes( $classes ){
	if( is_page() ){
...
add_filter( 'body_class', 'spiffy_page_template_body_classes' );
